                        ...
                        while (!validInput2) {
                            switch (s) {
                                case 1:
                                    ...
                                    importer.export();
                                    System.out
                                            .println("Succesfully transfered " + transfer + " from Checking to Account"
                                ...
                                case 2:
                                    ...
                                    importer.export();
                                    System.out
                                            .println("Succesfully transfered " + transfer2 + " from Checking to Account"
                                ...
                                case 3:
                                    ...
                                    importer.export();
                                    System.out
                                            .println("Succesfully transfered " + transfer3 + " from Checking to Account"
                        ...
                        while (!validInput3) {
                            switch (z) {
                                case 1:
                                    ...
                                    importer.export();
                                    System.out.println(
                                            "Succesfully transferred " + transfer + " from Savings to Checking");
                                    validInput3 = true;
                                    transfer(primary);
                                    break;
